...
public class Movie implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6618788017976850500L;
	@Id
	...
	public Movie(String name, String title, List<Cast> cast, int duration, List<Genre> genre, String synopsis,
